...
"typical values for multi-allelic forensic markers are in the range (0.60, 0.95)". This is based on the updated version of the database NorwegianFrequencies in
```{r}
